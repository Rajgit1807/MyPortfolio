...
const failed = () => toast.error("Please Try Again" ,{
  style:{width:"250px"}
  });
...
const sendEmail = (e:any) => {
    ...
    <div className="flex justify-center w-full pt-20 md:pt-32" id="contact">
      <div className="w-full max-w-[1800px] con-social" >
        ...
        <div className="ps-[20%] contact-me">
          ...
          <form className="w-full sm:max-w-md  mt-8 space-y-6" onSubmit={sendEmail} ref={form}>
        ...
        <div className="ps-[14%] social">
          <div className="social-div">
            ...
            <div className="flex gap-5 items-center mt-6">
              <a href="https://www.linkedin.com/in/rudra-raj-shrivastava-694626215/" target="_blank" rel="noopener noreferrer">
              <svg
  ...
  xmlns="http://www.w3.org/2000/svg"
              ...
              <a href="https://x.com/Rudrii1807" target="_blank" rel="noopener noreferrer">
              <svg
                className="transition-transform duration-300 hover:-translate-y-2 cursor-pointer"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 50 50"
              ...
              <a href="https://www.instagram.com/rudy_says_fl/" target="_blank" rel="noopener noreferrer">
              ...
              <a href="https://github.com/Rajgit1807" target="_blank" rel="noopener noreferrer">
              <svg
                className="transition-transform duration-300 hover:-translate-y-2 cursor-pointer"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 64 64"
